...
RaspberryPi3(Raspbian Stretch) + Neural Compute Stick(NCS) + RealSense D435 + MobileNet-SSD(MobileNetSSD)<br><br>
...
**However, the prediction rate is fairly low.(about 8.0 FPS)**<br>
